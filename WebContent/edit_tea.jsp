			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<form class="form-horizontal" role="form" id="add_tea_form">
				   <div class="form-group">
				      ...
				      <div class="col-sm-10">
				         <input type="text" name="tea_num" class="form-control" placeholder="">
				      </div>
				   </div>
				   ...
				   <div class="form-group">
				      ...
				      <div class="col-sm-10">
				         <input type="text" name="sex" class="form-control" placeholder="1:男 ，0:女">
				      </div>
				   </div>
				   ...
				   <div class="form-group">
				      ...
				      <div class="col-sm-10">
				         <input type="text" name="tea_intro" class="form-control" placeholder="">
				      </div>
				   </div>
				   
				   <div class="form-group">
				      <div class="col-sm-2 col-sm-offset-2">
				         <input type="submit" id="add_tea_but" class="form-control btn btn-primary" value="提交">
				      </div>
				   </div>
...
var add_tea_but = function(){
	$("#add_tea_but").click(function(){
		$.post("lxy/upteabyid/"+id,$("#add_tea_form").serializeArray(),function(data){
			if(data){
				alert("更新成功");
				window.location.href="ma_tea.jsp";
			}else{
				alert("更新失败");
			}
